...
- **OCR Agent** — Extracts text from PDFs (PyMuPDF) and images (Tesseract), with Gemini 2.5 Flash vision fallback
...
| LLM | Google Gemini 2.5 Flash (structured output, temperature 0) |
...
- Google AI API key (Gemini 2.5 Flash access, free tier)
...
└────────┘     └─────────┘     │                                       │
                               ...
                               └───────────────────────────────────────┘
                                        │                    │
                                        ▼                    ▼
                                 Tesseract/PyMuPDF     Google Gemini 2.5 Flash
```
